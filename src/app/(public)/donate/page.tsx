...
const impactIcons = [Heart, GraduationCap, Droplets, HandHeart, Waves, UtensilsCrossed];
            ...
            <ScrollReveal delay={150}>
              <div className="glass rounded-xl p-5 sm:p-8 lg:p-12">
                ...
                <div className="mt-8 p-4 bg-saffron/10 border border-saffron/20 rounded-sm">
                  ...
                  <p className="font-body text-xs text-ash mt-1 leading-relaxed">
                    Please call or email us after transferring so we can
        ...
        <div className="max-w-[800px] mx-auto px-6 lg:px-10 text-center">
          <ScrollReveal>
            ...
            <p className="font-body text-base text-ash font-light mt-6 leading-relaxed">
              We&apos;re here to help. Reach out to us by phone or email and
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 bg-saffron/10 border border-saffron/30 text-saffron px-8 py-3.5 rounded-xl font-body text-sm font-medium hover:bg-saffron/20 transition-colors backdrop-blur-md"
              >
                <Phone size={18} />
                Call Us
              </Link>
